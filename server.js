...
bot.start(async (ctx) => {
  const caption =
    `🚗 <b>Добрый день, на связи команда Fix Fast.FixFast</b>\n` +
    
    `Мы предоставляем услуги авто консьерж-сервиса и с радостью решим любой вопрос, связанный с обслуживанием вашего автомобиля!\n\n` +
    
    `Просто оформите заявку в мини-приложении и ваш автомобиль заберут в течении часа👇`;
